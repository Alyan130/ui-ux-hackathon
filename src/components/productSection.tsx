    ...
    <>
      <section className="py-14">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-2">
          <div className="w-full py-1 flex items-center justify-center mb-5">
            <span className="text-[24px] md:text-[32px] font-semibold text-color1">
              Products
            </span>
          </div>

          <div className="py-6 space-y-2 w-full flex flex-wrap gap-x-4 gap-y-10 justify-center md:justify-center">
